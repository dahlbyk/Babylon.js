    ...
    var DynamicTexture = (function (_super) {
        ...
        function DynamicTexture(name, options, scene, generateMipMaps, samplingMode) {
            ...
            if (options.getContext) {
                ...
                this._texture = scene.getEngine().createDynamicTexture(options.width, options.height, generateMipMaps, samplingMode, false);
            }
            else {
                this._canvas = document.createElement("canvas");
                if (options.width) {
                    this._texture = scene.getEngine().createDynamicTexture(options.width, options.height, generateMipMaps, samplingMode, options.forceExponentOfTwo || false);
                }
                else {
                    this._texture = scene.getEngine().createDynamicTexture(options, options, generateMipMaps, samplingMode, false);
                }
            }
